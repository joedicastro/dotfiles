...
#+BEGIN_SRC emacs-lisp
  ...
  ╭──────────────────────────────────────────────────────────────────────┴───────╯
    [_x_] counsel M-x [_p_] list      [_a_] apropos (helm)    [_t_] change theme
     ^ ^              [_i_] install   [_f_] info manual       [_l_] list emacs process
     ^ ^              [_u_] upgrade   [_k_] bindings          [_c_] init time
     ^ ^               ^ ^            [_b_] personal bindings [_e_] benchmark init
     ^ ^               ^ ^             ^ ^                    [_o_] unbound commands 
  --------------------------------------------------------------------------------
        "
