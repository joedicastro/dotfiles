...
#+BEGIN_SRC emacs-lisp
  ...
  ╭──────────────────────────────────────────────────────────────────────┴───────╯
    [_h_] helm M-x    [_p_] list      [_a_] apropos (helm)    [_t_] change theme (helm)
    [_x_] counsel M-x [_i_] install   [_f_] info manual       [_l_] list emacs process
